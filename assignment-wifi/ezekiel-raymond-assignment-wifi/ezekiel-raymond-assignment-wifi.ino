...
void handleRoot() {
 ...
 "<html>\
  <head>\
    ...
    <style>\
      body {margin: 30px;background-color: #34343b; font-family: Poppins, Arial, Helvetica, Sans-Serif;Color: #dadae8; text-align:center; line-height:2em; }\
    </style>\
  </head>\
  <body>\
    <h1>Welcome to the ESP8266-Ray Server!</h1>\
    <h3>Highscore by Level:%02d</h3>\
